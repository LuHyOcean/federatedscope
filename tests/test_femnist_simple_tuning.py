...
class Simple_tuning_Testing(unittest.TestCase):
    def setUp(self):
        print(('Testing %s.%s' % (type(self).__name__, self._testMethodName)))

    def set_config_femnist_simple_tuning(self, cfg):
        ...
        cfg.finetune.simple_tuning = True
        cfg.finetune.local_update_steps = 5
        cfg.finetune.local_param = ['fc2']
    ...
    def test_femnist_standalone(self):
        ...
        backup_cfg = self.set_config_femnist_simple_tuning(init_cfg)
