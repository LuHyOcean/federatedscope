...
class FEMNISTTest(unittest.TestCase):
    ...
    def set_config_femnist_quant(self, cfg):
        backup_cfg = cfg.clone()
        ...
        cfg.quantization.method = 'uniform'
        cfg.quantization.ubits = 16
    ...
    def test_femnist_quantization_standalone(self):
        init_cfg = global_cfg.clone()
        backup_cfg = self.set_config_femnist_quant(init_cfg)
        setup_seed(init_cfg.seed)
        update_logger(init_cfg, True)
